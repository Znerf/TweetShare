        ...
        Cache.prototype.loadImage = function (key) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
// ZZZ 							console.log('NULL', key.substring(0, 256));
// ZZZ							console.log('OPTIONS', this._options);
                        ...
                        case 1:
// ZZZ 							console.log('EINS');
                           src = _a.sent();
                            _a.label = 2;
                        case 2:
// ZZZ							console.log('ZWEI');
...
// ZZZ							console.log('DREI');
        ...
        Cache.prototype.proxy = function (src) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                xhr.onerror = reject;
//  ZZZ              xhr.open('GET', proxy + "?url=" + encodeURIComponent(src) + "&responseType=" + responseType);
                xhr.open('GET', proxy + src);
